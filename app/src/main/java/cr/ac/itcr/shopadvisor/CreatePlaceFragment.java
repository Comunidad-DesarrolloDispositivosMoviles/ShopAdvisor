...
import cr.ac.itcr.shopadvisor.access_data.IRepositroy;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                EditText n = (EditText)v.findViewById(R.id.txtName);
                if(!n.getText().toString().equals("")){
                    IRepositroy<Place> repository = new PlaceRepository(getContext().getApplicationContext());
                    Place p = new Place();
                    p.setName(n.getText().toString());
                    repository.Save(p);
                    ArrayList<Place> text = repository.GetAll();//Gets all data
                }else
                    Toast.makeText(getContext().getApplicationContext(),"The field is empty",Toast.LENGTH_SHORT).show();
            }
        });
        return view;
    }
